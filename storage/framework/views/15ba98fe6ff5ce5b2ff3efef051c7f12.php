        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item"><a href="<?php echo e(route('supplier.index')); ?>">Fournisseurs</a></div>
                    <div class="breadcrumb-item">Modifier un fournisseur</div>
                </div>
            </div>
            ...
            <div class="section-body">
                ...
                <div class="card">
                    <form action="<?php echo e(route('supplier.update', $supplier)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/fustimolnarpatrick/laravel-coffeshop/resources/views/pages/supplier/edit.blade.php ENDPATH**/ ?>
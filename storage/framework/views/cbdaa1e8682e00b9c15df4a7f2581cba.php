    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                ...
                <div class="card">
                    <form action="<?php echo e(route('reservation.update', $reservation)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                    name="customer_name" value="<?php echo e($reservation->customer_name); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                    name="customer_phone" value="<?php echo e($reservation->customer_phone); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="date" id="reservation_date" value="<?php echo e($reservation->reservation_date); ?>" name="reservation_date" required>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="time" id="reservation_time" value="<?php echo e($reservation->reservation_time); ?>" name="reservation_time" required>
...
unset($__errorArgs, $__bag); ?>"
                                    name="table_number" value="<?php echo e($reservation->table_number); ?>">
...
unset($__errorArgs, $__bag); ?>" name="status" id="status">
                                    <option value="pending"<?php echo e(old('status') == 'pending' ? ' selected' : ''); ?>>Attente</option>
                                    <option value="confirmed"<?php echo e(old('status') == 'confirmed' ? ' selected' : ''); ?>>Confirmé</option>
                                    <option value="seated"<?php echo e(old('status') == 'seated' ? ' selected' : ''); ?>>À table</option>
                                    <option value="cancelled"<?php echo e(old('status') == 'cancelled' ? ' selected' : ''); ?>>Annulé</option>
                                    <option value="completed"<?php echo e(old('status') == 'completed' ? ' selected' : ''); ?>>Fini</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>"
                                    name="notes" value="<?php echo e($reservation->notes); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/fustimolnarpatrick/laravel-coffeshop/resources/views/pages/reservation/edit.blade.php ENDPATH**/ ?>
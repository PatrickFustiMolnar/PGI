        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">Ajouter une catégorie</div>
                </div>
            </div>

            <div class="section-body">
                <h2 class="section-title">Nouvel catégorie</h2>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/fustimolnarpatrick/laravel-coffeshop/resources/views/pages/category/create.blade.php ENDPATH**/ ?>
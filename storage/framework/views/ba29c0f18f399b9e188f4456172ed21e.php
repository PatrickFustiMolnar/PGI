<?php $__env->startSection('title', 'Réglages'); ?>
        ...
        <section class="section">
            ...
            <div class="section-body">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="GET" action="<?php echo e(route('settings.edit')); ?>">
                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group">
                                ...
                                <a href="<?php echo e(route('dashboard')); ?>" class="btn btn-secondary">Annuler</a>
                            </div>
                        </form>
                    </div>
                </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/fustimolnarpatrick/laravel-coffeshop/resources/views/pages/settings/index.blade.php ENDPATH**/ ?>
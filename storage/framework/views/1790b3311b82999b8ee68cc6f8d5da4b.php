        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">Mettre à jour</div>
                </div>
            </div>
            ...
            <div class="section-body">
                ...
                <div class="card">
                    <form action="<?php echo e(route('inventory.update', $inventory)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                    name="name" value="<?php echo e($inventory->name); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                    name="stock" value="<?php echo e($inventory->stock); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/fustimolnarpatrick/laravel-coffeshop/resources/views/pages/inventory/edit.blade.php ENDPATH**/ ?>
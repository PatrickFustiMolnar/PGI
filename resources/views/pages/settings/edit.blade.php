...
@section('title', 'Modifier les Réglages')
    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Modifier les Réglages</h1>
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item active"><a href="{{ route('dashboard') }}">Dashboard</a></div>
                    <div class="breadcrumb-item"><a href="{{ route('settings') }}">Réglages</a></div>
                    ...
                    <form method="POST" action="{{ route('settings.update') }}">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <small class="form-text text-muted">Requis uniquement si vous modifiez le mot de passe.</small>
                        ...
                        <div class="card-footer text-right">
                            <a href="{{ route('settings') }}" class="btn btn-secondary">Annuler</a>
